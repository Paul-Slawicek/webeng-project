  ...
  <div>
    <div class="form-container register-container">
      <form @submit.prevent="$emit('submitRegistration')">
        <SalutationField
          id="salutation"
          otherInputId="otherSalutation"
          label="Title"
          placeholder="Select Title"
          :options="salutationOptions"
          :salutation="localSalutation"
          :otherSalutation="localOtherSalutation"
        ...
        <div class="row mb-2">
          ...
          <div class="col-md-6">
            <InputField type="email" id="email" label="Email Address" placeholder="Email Address"
              :modelValue="localEmail" @update:modelValue="$emit('update:email', $event)" />
          </div>
        </div>
        ...
        <div class="row mb-2">
          <div class="col-md-6">
            <InputField type="password" id="password" label="Password" placeholder="Password"
              :modelValue="localPassword" @update:modelValue="$emit('update:password', $event)" />
          </div>
          <div class="col-md-6">
